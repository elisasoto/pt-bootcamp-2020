import imgNote from '../assets/planta.webp'

function NotaCuatro () {
    return (
        <div className="collumn">
            <div className="head">
                <span className="headline hl3">Regó una planta por 2 años y descubre que era Falsa </span>
                <p><span className="headline hl4">Mujer riega diariamente su la planta de interior antes de descubrir que es falsa.</span></p></div>

                <p>Mujer riega diariamente su la planta de interior antes de descubrir que es falsa.
                    ...
                    Pero un día todo se desmorono para Caelie, la planta a la que tanto cuidado le dio, era de plástico </p>
                    <figure className="figure">
                        <img className="media" src={imgNote} alt="planta"></img>
                        <figcaption className="figcaption">Planta ficticia durante la entrevista</figcaption>
                </figure>
                <p>Un día Caelie, decidió dar un nuevo hogar a su planta y fue allí cuando la experta jardinera descubrió que su plantita no tenía raíces.
