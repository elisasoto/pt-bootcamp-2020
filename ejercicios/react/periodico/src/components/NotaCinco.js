import imgNote from '../assets/popaux.webp'

function NotaCinco () {
    return (
        <div className="collumn">
            <div className="head">
                <span className="headline hl1">Hacer mucha fuerza cuando defecamos podría llegar a matarnos </span>
                <p><span className="headline hl4">by FRANZ KAFKA</span></p></div>
                ...
                <figure className="figure">
                    <img className="media" src={imgNote} alt="caca"></img>
                    <figcaption className="figcaption">Demostracion científica</figcaption>
            </figure>

				<p>Pero para formar parte de esta estadística (de mierda) debemos cumplir con dos circunstancias particulares; primero tener algún tipo de patología cardiovascular, como ser insuficiencia cardiaca. Segundo tener problemas de estreñimientos, es decir, evacuar de manera muy dura o seca.
