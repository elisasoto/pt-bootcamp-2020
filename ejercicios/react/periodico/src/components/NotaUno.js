import imgNote from '../assets/exorcismo.gif'

function NotaUno () {
    return (
        <div className="collumn">
            <div className="head">
               <span className="headline hl3">Exorcistas se reúnen para combatir a Satanás y evitar que se extienda por Internet</span>
               <p><span className="headline hl4">240 exorcistas de todo el mundo se han reunido en Roma para compartir experiencias sobre combatir al diablo.</span></p>
            </div>    
            ...
            Muchos de nosotros mencionamos la palabra ocultismo, pero realmente, ¿Qué es el ocultismo? Es por ello que este grupo de curas, sacerdotes y monjas se ha reunido en la capital mundial del catolicismo para debatir cómo luchar contra el mal de manera online
                ...
                “Cada día practico cuatro o cinco exorcismos con el teléfono móvil”, decía uno de los asistentes al curso.</p>

                <figure className="figure">
                        <img className="media" src={imgNote} alt="exorcismo"></img>
                        <figcaption className="figcaption">Padre Damien Karras & Padre Lankester Merrin </figcaption>
                </figure>

            <p> Su método de usar la tecnología para vencer al diablo consiste en rezar a través de llamadas y las redes sociales, apelar a la fe del poseído y gritarle con dureza a Satanás, obligando a callar sus malas influencias en la víctima.
            ...
            Es por ello que debes tener cuidado. Si tu página web no carga rápidamente, o se corta el Wifi, piensa que el diablo puede estar metiendo la cola…</p>
        </div>
    )
}
